...
const Home = () => {
    ...
    return (
        ...
        >
            <style>{styles}</style>
            <Helmet>
                <title>Klivra | Workspace Dashboard</title>
                <meta name="description" content="Access your Klivra workspace dashboard. Manage your projects, track tasks, and view real-time team analytics." />
            </Helmet>
