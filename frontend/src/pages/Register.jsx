                    ...
                    <div className="bg-white/[0.02] backdrop-blur-2xl border border-white/[0.06] rounded-2xl p-7 shadow-2xl shadow-black/20">
                        ...
                        <div className="mt-6">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {/* Google Button */}
                                <a href="http://localhost:5000/api/auth/google" className="flex items-center justify-center gap-2 px-4 py-2.5 bg-white text-zinc-700 hover:bg-zinc-50 ring-1 ring-zinc-200 rounded-xl font-semibold text-[13px] shadow-sm transition-all active:scale-[0.98]">
                                ...
                                {/* GitHub Button */}
                                <a href="http://localhost:5000/api/auth/github" className="flex items-center justify-center gap-2 px-4 py-2.5 bg-[#24292e] text-white hover:bg-black rounded-xl font-semibold text-[13px] shadow-sm transition-all active:scale-[0.98]">
