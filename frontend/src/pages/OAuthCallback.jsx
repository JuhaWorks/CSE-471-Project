        ...
        <div className="min-h-screen flex items-center justify-center bg-[#05050a]">
            ...
            >
                <div className="relative">
                    ...
                    />
                    {/* Inner glowing core */}
                    <div className="relative w-16 h-16 bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl flex items-center justify-center shadow-violet-500/20 box-border pointer-events-none">
                        <svg className="w-6 h-6 text-violet-400 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div className="mt-3 flex gap-1">
                    <motion.div className="w-1 h-1 rounded-full bg-violet-500" animate={{ y: [0, -4, 0] }} transition={{ duration: 0.6, repeat: Infinity, delay: 0 }} />
                    <motion.div className="w-1 h-1 rounded-full bg-violet-400" animate={{ y: [0, -4, 0] }} transition={{ duration: 0.6, repeat: Infinity, delay: 0.15 }} />
                    <motion.div className="w-1 h-1 rounded-full bg-violet-300" animate={{ y: [0, -4, 0] }} transition={{ duration: 0.6, repeat: Infinity, delay: 0.3 }} />
                </div>
            </motion.div>
        </div>
    );
