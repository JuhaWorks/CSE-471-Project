                ...
                <AnimatePresence>
                    {isLockedByOthers && (
                        <motion.div
                            ...
                            exit={{ opacity: 0, y: 5 }}
                            className="flex items-center gap-1.5 px-2 py-1 bg-blue-500/10 border border-blue-500/20 rounded-md"
                        >
            ...
            <div className={`relative transition-all duration-300 ${isLockedByOthers ? 'scale-[0.99] opacity-80' : ''}`}>
                <Component
                    ...
                    className={`
                        ...
                        ${isLockedByOthers
                            ? 'border-blue-500/30 ring-4 ring-blue-500/5 cursor-not-allowed bg-blue-500/[0.02]'
                ...
                <AnimatePresence>
                    {isLockedByMe && (
                        ...
                        >
                            <div className="px-2 py-1 bg-violet-500/20 border border-violet-500/30 rounded-lg flex items-center gap-1.5">
                                <div className="w-1.5 h-1.5 rounded-full bg-violet-500 animate-pulse" />
                                <span className="text-[9px] font-black text-violet-400 uppercase tracking-widest">You're editing</span>
                            </div>
                        </motion.div>
                    )}
                </AnimatePresence>
