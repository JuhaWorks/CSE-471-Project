    ...
    return (
        <div className="space-y-10">
            ...
            {isCreator ? (
                ...
                <div className="bg-white/[0.02] border border-white/5 rounded-[2.5rem] p-12 text-center space-y-4">
                    ...
                    <h3 className="text-xl font-black text-white tracking-tight">Ownership Required</h3>
                    <p className="text-sm text-gray-500 max-w-sm mx-auto leading-relaxed">
                        Only the project creator has the authority to archive or delete this workspace. 
                        Please contact the project owner for any structural changes.
                    </p>
                </div>
            )}
