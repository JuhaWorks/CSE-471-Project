...
const SidebarComponent = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            <aside className={`
                fixed top-0 left-0 h-full z-50 w-[260px] bg-[#0a0a12] border-r border-white/[0.06]
            ...
            `}>
                ...
                <nav className="flex-1 py-5 px-3 space-y-0.5 overflow-y-auto">
                    <p className="px-3 mb-3 text-[10px] font-bold text-gray-600 uppercase tracking-[0.15em]">Navigation</p>
                    {navItems.map((item) => (
                        <NavLink
                            key={item.path}
                            to={item.path}
                ...
                {/* Bottom */}
                <div className="px-3 pb-4 space-y-0.5 border-t border-white/[0.06] pt-4">
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] font-medium text-gray-500 hover:text-red-400 hover:bg-red-500/5 transition-all duration-200"
                    >
                        <svg className="w-[18px] h-[18px] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
