                ...
                <div className="relative hidden sm:block max-w-sm w-full group">
                    ...
                    <input 
                        ...
                        className={twMerge(clsx(
                            "w-full pl-11 pr-4 py-2 bg-white/5 border border-white/10 rounded-2xl text-sm text-[var(--text-main)] placeholder-gray-500 outline-none",
                ...
                <div className="relative" ref={dropdownRef}>
                    ...
                    >
                        ...
                        <div className="hidden sm:block text-left mr-1">
                            <p className="text-sm font-bold text-[var(--text-main)] leading-none">{user?.name || 'User'}</p>
